...
const options = {
    ...
    followUserMaxFollowers : 1000000,

    followUserMaxFollowing: 3000,
  ...
  (async () => {
    ...
    try {
      ...
      const usersToFollowFollowersOf = ['tasadof_najoor1' , 'pelakmelli' , 'kish_car' , 'mansory'];
  
      // Now go through each of these and follow a certain amount of their followers
      await instauto.followUsersFollowers({ usersToFollowFollowersOf, skipPrivate: false, enableLikeImages: true });
